...
export default async function fetchEvents(data: any, id: any, latitude:any, longitude:any) {
    ...
    const fetchEventsApi = await fetch(`${process.env.NEXTAUTH_URL}/api/events/${id}`)
